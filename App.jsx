...
import { Menu, User, ArrowLeft, Thermometer, Droplets, Battery, Sun, Calendar, Phone, CheckCircle, Home, Square, ArrowLeftCircle } from 'lucide-react';
...
const App = () => {
  ...
  const NavigationBar = () => (
    <div className="fixed bottom-0 left-0 right-0 bg-gray-900 text-white py-3 px-6 flex items-center justify-around z-50 max-w-md mx-auto">
      <button className="flex flex-col items-center" onClick={() => setCurrentPage('dashboard')}>
  ...
  const ProduceSettingsPage = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 pb-32 relative">
        ...
        <div className="fixed bottom-16 left-0 right-0 p-4 bg-gradient-to-t from-gray-50 to-transparent z-20 max-w-md mx-auto">
          <button
